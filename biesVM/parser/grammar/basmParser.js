...
const serializedATN = [4,1,27,56,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,
...
0,2,4,6,8,10,12,0,1,1,0,6,23,53,0,17,1,0,0,0,2,20,1,0,0,0,4,29,1,0,0,0,6,
...
30,5,2,0,0,30,31,5,3,0,0,31,32,5,24,0,0,32,33,5,4,0,0,33,34,5,24,0,0,34,
35,5,5,0,0,35,36,5,3,0,0,36,37,5,24,0,0,37,5,1,0,0,0,38,42,3,12,6,0,39,41,
3,8,4,0,40,39,1,0,0,0,41,44,1,0,0,0,42,40,1,0,0,0,42,43,1,0,0,0,43,7,1,0,
0,0,44,42,1,0,0,0,45,49,5,24,0,0,46,49,5,25,0,0,47,49,3,10,5,0,48,45,1,0,
0,0,48,46,1,0,0,0,48,47,1,0,0,0,49,9,1,0,0,0,50,51,5,3,0,0,51,52,5,24,0,
...
export default class basmParser extends antlr4.Parser {
	...
	block() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while((((_la) & ~0x1f) === 0 && ((1 << _la) & 16777152) !== 0)) {
	            this.state = 21;
	            this.inst();
	            this.state = 26;
	            this._errHandler.sync(this);
	...
	inst() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while((((_la) & ~0x1f) === 0 && ((1 << _la) & 50331656) !== 0)) {
	            this.state = 39;
	            this.arg();
	            this.state = 44;
	            this._errHandler.sync(this);
