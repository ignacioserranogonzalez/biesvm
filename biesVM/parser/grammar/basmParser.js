...
const serializedATN = [4,1,52,78,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,
...
1,7,1,7,1,8,1,8,1,8,0,0,9,0,2,4,6,8,10,12,14,16,0,1,1,0,9,46,78,0,21,1,0,
...
35,5,3,0,0,35,36,5,47,0,0,36,37,5,4,0,0,37,38,5,47,0,0,38,39,5,5,0,0,39,
40,5,3,0,0,40,41,5,47,0,0,41,5,1,0,0,0,42,46,3,16,8,0,43,45,3,8,4,0,44,43,
1,0,0,0,45,48,1,0,0,0,46,44,1,0,0,0,46,47,1,0,0,0,47,7,1,0,0,0,48,46,1,0,
0,0,49,56,5,47,0,0,50,56,5,49,0,0,51,56,5,48,0,0,52,56,3,10,5,0,53,56,3,
12,6,0,54,56,3,14,7,0,55,49,1,0,0,0,55,50,1,0,0,0,55,51,1,0,0,0,55,52,1,
0,0,0,55,53,1,0,0,0,55,54,1,0,0,0,56,9,1,0,0,0,57,58,5,3,0,0,58,59,5,47,
0,0,59,11,1,0,0,0,60,61,5,50,0,0,61,13,1,0,0,0,62,71,5,6,0,0,63,68,5,47,
0,0,64,65,5,7,0,0,65,67,5,47,0,0,66,64,1,0,0,0,67,70,1,0,0,0,68,66,1,0,0,
...
export default class basmParser extends antlr4.Parser {
    ...
    static symbolicNames = [ null, null, null, null, null, null, null, null, 
                             ...
                             "SIGNED_INT", "STR", "TYPE", "COMMENT", "WS" ];
	...
	block() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while((((_la) & ~0x1f) === 0 && ((1 << _la) & 4294966784) !== 0) || ((((_la - 32)) & ~0x1f) === 0 && ((1 << (_la - 32)) & 32767) !== 0)) {
	            this.state = 25;
	            this.inst();
	            this.state = 30;
	            this._errHandler.sync(this);
	...
	inst() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===3 || _la===6 || ((((_la - 47)) & ~0x1f) === 0 && ((1 << (_la - 47)) & 15) !== 0)) {
	            this.state = 43;
	            this.arg();
	            this.state = 48;
	            this._errHandler.sync(this);
	...
	mnemonic() {
	    ...
	    try {
	        ...
	        this.state = 75;
	        _la = this._input.LA(1);
	        if(!((((_la) & ~0x1f) === 0 && ((1 << _la) & 4294966784) !== 0) || ((((_la - 32)) & ~0x1f) === 0 && ((1 << (_la - 32)) & 32767) !== 0))) {
...
basmParser.T__45 = 46;
basmParser.INT = 47;
basmParser.SIGNED_INT = 48;
basmParser.STR = 49;
basmParser.TYPE = 50;
basmParser.COMMENT = 51;
basmParser.WS = 52;
